...
export class FullcourseComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    // Set the video ID, using default if not provided in the URL
    this.video = videoId || 'fnlJw9H0xAM';
    ...
    // Fetch chapter and course lists
  ...
  private extractVideoIdFromUrl(): string | null {
    ...
    const videoIdIndex = segments.indexOf('fullcourse') + 1; // Next segment after 'fullcourse'
    return segments[videoIdIndex] || null;
  }
